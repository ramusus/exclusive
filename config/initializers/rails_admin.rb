...
RailsAdmin.config do |config|
  ...
  config.model Page do
    ...
    edit do
      include_fields :title, :slug, :person, :menu
      include_fields :content, :important do
        ckeditor true
  ...
  config.model Person do
    list do
      include_fields :name, :occupation
    end
    edit do
      include_fields :name, :occupation, :avatar
      include_fields :description do
        ckeditor true
        ckeditor_config_js '/javascripts/ckeditor/config.js'
      end
    end
